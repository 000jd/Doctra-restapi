...
class Interface(object):
    ...
    def __init__(self, intents, methods={}, model_name="assistant_model",):
    ...
    def train_model(self, epoch):
        ...
        self.hist = self.model.fit(np.array(train_x), np.array(
            train_y), epochs=epoch, batch_size=5, verbose=1)
    ...
    def request(self, message):
        ...
        if ints[0]['intent'] in self.methods.keys():
            self.methods[ints[0]['intent']]()
        else:
